...
{
    public class SeedingService // Serviço para popular o banco de dados
    {
        private SalesWebMvcContext _context { get; set; }

        // Injeção de dependência
        // Dependência do tipo SalesWebMvcContext será inicializada quando for instanciado um serviço SeedinService
        ...
        public void Seed()
        {
            // Se o banco está populado não, popula/carrega dados no banco
            if (_context.Department.Any() || _context.Seller.Any() || _context.SalesRecord.Any())
            {
                return; 
            }

            // Se o banco não está poulado, Popula o banco de dados
            Department d1 = new Department(1, "Computers");
            Department d2 = new Department(2, "Electronics");
            Department d3 = new Department(3, "Fashion");
            Department d4 = new Department(4, "Books");
            Department d5 = new Department { Id = 5, Name = "Games"};
            ...
            // AddRange permite adicionar varios objetos simultaneamente
            ...
            // SaveChanges, salva e confirma as alterações no banco de dados
